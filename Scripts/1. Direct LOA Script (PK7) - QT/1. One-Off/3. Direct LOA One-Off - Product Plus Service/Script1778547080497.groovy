...
for (int i = 1; i <= loopCountService; i++) {
	...
	TestObject spec1Service = findTestObject('null')
	...
	t(findTestObject('null'), FreqperUOM, 20)
	waitBlockUI(30)
	WebUI.delay(1)

	// Input Service Quantity
	t(findTestObject('null'), ServiceQty, 20)
	waitBlockUI(30)
	WebUI.delay(1)
	
	// Input Service Unit Price(RM)
	t(findTestObject('null'), ServiceUnitPrice, 20)
	waitBlockUI(30)
	WebUI.delay(1)
	...
	TestObject spec2Service = findTestObject('null')
...
String filePath = baseDir + "/Direct_LOA_Non-Zonal_One-Off_PK7_ProductplusService_AP_201_2026.xlsx"
