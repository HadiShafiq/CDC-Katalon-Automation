 ...
 * - submit login
 * ========================= */
TestObject topMenuLogin = findTestObject('Direct LOA/1. Direct LOA Requistioner/Login/Right Top Menu Login')
TestObject btnLogin = findTestObject('Direct LOA/1. Direct LOA Requistioner/Login/Submit Username and Password')


// make sure login button ready
WebUI.waitForElementClickable(topMenuLogin, 20)
c(topMenuLogin, 20)

// wait after click login
...
// make sure login button ready
WebUI.waitForElementClickable(btnLogin, 20)
c(btnLogin, 20)
...
TestObject ddlLanguage = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Common Page/Dropdown Language')
TestObject btnCreateLOA = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Dashboard/Create LOA')

// wait until post-login object appears
WebUI.waitForElementVisible(ddlLanguage, 30)
WebUI.waitForElementClickable(btnCreateLOA, 30)

// only continue after login really completed
WebUI.selectOptionByValue(ddlLanguage, 'en_US', true)
c(btnCreateLOA, 20)
waitBlockUI(30)
...
String loaOfferedPrice2 = LOAOfferedPrice.toString()

	BigDecimal loaPrice2  = new BigDecimal(
	loaOfferedPrice2.replace(",", "").trim()

	)
if (Agreement == 2 && loaPrice2 > 500000) {
...
// Only run schedule flow if FulfilmentType = 2
if (FulfilmentType == 2) {
 ...
 * ========================= */
String filePath = "C:\\Users\\hadishafiq\\Desktop\\PrepData\\Direct_LOA_Open_Service_Schedule_And_As_When_AP_201_2026.xlsx"
