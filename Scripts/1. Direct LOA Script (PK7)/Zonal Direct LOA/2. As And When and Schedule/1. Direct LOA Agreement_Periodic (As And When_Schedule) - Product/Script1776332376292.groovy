...
for (int i = 1; i <= loopCount; i++) {
	...
	// Input Quantity
		// 2 quantity values
		List qtyList = [ProductQuaty1, ProductQuaty2]
	...
	// fill tbl0 and tbl1
	List unitPriceList = [ProductUnitPrice1, ProductUnitPrice2]
 ...
 * ========================= */
String filePath = "C:\\Users\\hadishafiq\\Desktop\\PrepData\\LOA_Zonal_PK7_Product_AsAndWhen_Shedule_2026.xlsx"
