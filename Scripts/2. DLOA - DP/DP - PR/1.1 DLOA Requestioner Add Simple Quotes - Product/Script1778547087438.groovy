...
pickDate("2026-03-14")   // <-- put your date here
waitBlockUI(20)
WebUI.delay(1)
...
for (int i = 1; i <= loopCount; i++) {
    ...
    // Click Action Item for Product
    c(findTestObject('Object Repository/DLOA/4. DLOA - Requestioner/1. General Information/Click Action Item for Product'), 20)
    waitBlockUI(20)
    WebUI.delay(1)

    // Input Specification 1 TextBox with dynamic text for each loop
    TestObject spec1 = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Input Specification 1 TextBox')
    WebUI.waitForElementVisible(spec1, 20)
    WebUI.waitForElementClickable(spec1, 20)
    WebUI.click(spec1)                 // focus
    WebUI.clearText(spec1)             // clear existing value
	waitBlockUI(20)
	WebUI.delay(1)
    
    // Add the loop index to the ProductSpecification1 value
    String specificationText = ProductSpecification1 + i  // Append loop index to the specification text
    WebUI.setText(spec1, specificationText) // type new value
    waitBlockUI(20)
    WebUI.delay(1)
    ...
    WebUI.selectOptionByIndex(findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Dropdown Price Type'), toInt(PriceType))
    waitBlockUI(20)
    WebUI.delay(1)
    ...
    // Input Delivery Period
    t(findTestObject('Object Repository/DLOA/4. DLOA - Requestioner/1. General Information/Delivery Period'), DeliveryPeriod, 20)
    waitBlockUI(20)
    WebUI.delay(1)
    ...
    WebUI.click(specBtn)
    c(findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Click Specification'), 20)
	waitBlockUI(20)
	WebUI.delay(1)

    // Input Specification 2 TextBox
	TestObject spec2 = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Input Specification 2 TextBox')
	WebUI.waitForElementVisible(spec2, 20)
	WebUI.waitForElementClickable(spec2, 20)
	WebUI.click(spec2)                 // focus
	WebUI.clearText(spec2)             // clear existing value
	waitBlockUI(20)
	WebUI.delay(1)
		
	// Add the loop index to the ProductSpecification2 value
	String specificationText2 = ProductSpecification2 + i  // Append loop index to the specification text
	WebUI.setText(spec2, specificationText2) // type new value
	waitBlockUI(20)
    WebUI.delay(1)
	}
	
/* =========================
* Zone Item - Delete Services
* ========================= */
TestObject deleteButton = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Delete Button services')
	
WebUI.click(deleteButton)
	
TestObject yesButton = findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/Zone Item Tab/Add Product/Delete Popup Click Yes')
