...
WebUI.click(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Click Search PR-LOA Prepared By'))
 
 selectDropdownByIndex(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Dropdown Username'), 1)
 
 WebUI.setText(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Input Prepared Username'),PreparedBy)
 WebUI.delay(1)
 
 WebUI.click(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Click Search button'))
 WebUI.delay(1)
 
 WebUI.click(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Click Prepared Name in Table'))
 WebUI.delay(1)
 
 WebUI.click(findTestObject('Object Repository/DLOA/6. Prepare Request Note/Click Select Button'))
