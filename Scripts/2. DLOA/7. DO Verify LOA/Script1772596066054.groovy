...
//Verify LOA
WebUI.click(findTestObject('Object Repository/DLOA/11. DO Verify LOA/Download All button'))

WebUI.click(findTestObject('Object Repository/DLOA/11. DO Verify LOA/DO verify'))
...
String filePath = baseDir + "/DLOA_DO_Verify_April_2026.xlsx"
