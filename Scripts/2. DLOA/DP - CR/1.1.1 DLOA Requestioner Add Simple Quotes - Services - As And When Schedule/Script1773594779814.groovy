...
for (int i = 1; i <= loopCount; i++) {
	...
	TestObject clickSpec = findTestObject('Object Repository/DLOA/4. DLOA - Requestioner/2. Item List/Click Specification Fahmi')
...
String filePath = baseDir + "/FAHMI DP.xlsx"
