...
WebUI.click(findTestObject('Object Repository/DLOA/Assign Button/Assign Button 1'))

WebUI.setText(findTestObject('Object Repository/Direct LOA/2. Direct LOA Supplier/Zone Item/Zone Item Supplier Product/Input Item Code'),
	P_Item_Code)

WebUI.click(findTestObject('Object Repository/DLOA/Assign Button/Search Button'))

WebUI.click(findTestObject('Object Repository/DLOA/Assign Button/Click Product Link'))
...
WebUI.click(findTestObject('Object Repository/Direct LOA/2. Direct LOA Supplier/Zone Item/Zone Item Supplier Product/Action Button for Result'))

/* =========================
 * Zone Item Product
 * ========================= */

WebUI.click(findTestObject('Object Repository/DLOA/Assign Button/Assign Button 2'))
 ...
 * ========================= */
c(findTestObject('Object Repository/DLOA/Assign Button/Submit Button'), 20)
waitBlockUI(30)
 ...
 * Sign Out
 * ========================= */
c(findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/LogOut/Click Menu For Sign Out'), 20)
waitBlockUI(10)
WebUI.delay(1)

c(findTestObject('Object Repository/Direct LOA/1. Direct LOA Requistioner/LogOut/Click Sign Out'), 20)
waitBlockUI(20)
WebUI.waitForPageLoad(20)
