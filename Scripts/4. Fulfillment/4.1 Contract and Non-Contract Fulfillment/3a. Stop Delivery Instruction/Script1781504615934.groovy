...
//Fulfilment List Menu
c(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Click Fulfilment Maintenance'))

//Dropdown Transaction Type
selectDropdownByIndex(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Dropdown Transaction Type'),ddTransactionType)
waitBlockUI(20)
WebUI.delay(1)

//Dropdown Document No
selectDropdownByIndex(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Dropdown Document Type'),ddDocumentNo)

//Input Purchase Order Number
t(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Input Document No'), PO_Number)

// Searching Purchase Number
c(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Search TaskList'))

//Click Option
c(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Click Option'))
waitBlockUI(10)
WebUI.delay(0.5)

//Click Delivery Item
c(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Click Stop Delivery Instruction'))

/* ================================================
 * Stop Delivery Instruction Justification
 * ================================================*/
//Justification 
selectDropdownByIndex(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Dropdown Justification'),ddDocumentNo)

//Explanation
t(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Input Explanation'), Explanation)

/* ========================
 * STOP FULFILMENT BUTTON
 * ========================*/
c(findTestObject('Object Repository/DP - Add To Cart/Pending Delivery List/Button Stop Fulfilment'))
waitBlockUI(10)
WebUI.delay(0.5)
...
String filePath = baseDir + '/Stop_Delivery_Instruction.xlsx'
