...
c(findTestObject('Object Repository/FD and Agreement/Agreement Application/Common TaskList Funtion/GroupTask TaskList Dropdown'))
waitBlockUI(20)

selectDropdownByIndex(findTestObject('Object Repository/FD and Agreement/Agreement Application/Agreement/Document Type TaskList'), DocumentType)
waitBlockUI(20)
WebUI.delay(0.5)

c(findTestObject('Object Repository/FD and Agreement/Agreement Application/Common TaskList Funtion/GroupTask Serach Button'))
waitBlockUI(30)
WebUI.delay(1)
...
t(findTestObject('Object Repository/FD and Agreement/Agreement Application/Common TaskList Funtion/GroupTask Document No'),
	Document_Number)

selectDropdownByIndex(findTestObject('Object Repository/FD and Agreement/Agreement Application/Agreement/Document Type TaskList'), 1)
waitBlockUI(20)
WebUI.delay(0.5)
...
c(findTestObject('Object Repository/FD and Agreement/Agreement Application/Agreement/Claim Button'))*/
