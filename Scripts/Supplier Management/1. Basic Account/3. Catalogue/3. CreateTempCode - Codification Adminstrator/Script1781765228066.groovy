...
//Login
	...
	t(findTestObject('Object Repository/Home Page/LoginPage/LoginID'), AssigneeUsername)
	t(findTestObject('Object Repository/Home Page/LoginPage/Password'), AssigneePassword)
...
//Task list
	...
	//Claim request
	c(findByXPath("//tr[.//div[text()='" + rncNumber + "']]//button[.//span[text()='Claim']]"))
	waitBlockUI(1)
	
	//Refresh the current web page
	WebUI.refresh()
	
	// Create Item Code + find by rnc number
	c(findByXPath("//tr[.//div[text()='" + rncNumber + "']]//a[text()='Create Item Code']"))
	...
	//Segment 
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SegmentFind'))
	selectDropdownByIndex(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SearchDropdown'), '1')
	//Input code and search
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeInput'), UNSPSC_CodeSegment)
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeSearch'))

	//Click first code from result
	...
	//Family
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/FamilyFind'))
	selectDropdownByIndex(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SearchDropdown'), '1')
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeInput'), UNSPSC_CodeFamily)
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeSearch'))
	//Click first code from result
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/FirstCodeResult'))
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SelectButton'))
	...
	//Class
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/ClassFind'))
	selectDropdownByIndex(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SearchDropdown'), '1')
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeInput'), UNSPSC_CodeClass)
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeSearch'))
	waitBlockUI(1)
	//Click first code from result
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/FirstCodeResult'))
	...
	//Commodity - Have to be unique 
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/CommodityUnique/CommodityCode'),UNSPSC_CodeCommodity)
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/CommodityUnique/CommodityTitleBahasa'), UNSPSC_BMTitleCommodity)
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/CommodityUnique/CommodityTitleEnglish'),UNSPSC_EngTitleCommodity)
	
	
	//Submit
	c(findTestObject('Object Repository/CreateCatalogue/ReviewRequest/SubmitUNSPSCRequest'))
	waitBlockUI(1)