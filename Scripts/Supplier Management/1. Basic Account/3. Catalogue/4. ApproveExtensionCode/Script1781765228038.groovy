...
//Login
	...
	t(findTestObject('Object Repository/Home Page/LoginPage/LoginID'), ApproverUsername)
	t(findTestObject('Object Repository/Home Page/LoginPage/Password'), ApproverPassword)
	...
	//Targets the first from task list
	c(findByXPath("//tr[.//div[text()='" + rncNumber + "']]//a[text()='Approve Extension Code']"))
	//Claim request
	c(findTestObject('Object Repository/CreateCatalogue/ReviewRequest/ClaimUNSPSCRequest'))
	
// Existing extension dropdown, click N/A
selectDropdownByIndex(findByXPath("(//div[contains(@class,'ui-selectonemenu')])[1]"), 1)
selectDropdownByIndex(findByXPath("(//div[contains(@class,'ui-selectonemenu')])[3]"), 1)
selectDropdownByIndex(findByXPath("(//div[contains(@class,'ui-selectonemenu')])[5]"), 1)
selectDropdownByIndex(findByXPath("(//div[contains(@class,'ui-selectonemenu')])[7]"), 2)
	

	//Endorse & Publish
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/Endorse_Publish'))