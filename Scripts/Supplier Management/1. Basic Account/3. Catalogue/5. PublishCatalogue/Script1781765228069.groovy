...
//Login
	...
	//Task list
	c(findTestObject('Object Repository/Home Page/TaskList'))
	
	//Targets from task list using rnc
	c(findByXPath("//tr[.//div[text()='" + rncNumber + "']]//a[text()='Publish Result Notification']"))
	//Add to catalogue
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/AddToCatalogue'))
	
	c(findTestObject('Object Repository/Home Page/SupplierPage/Overview'))
	
	c(findTestObject('Object Repository/Home Page/SupplierPage/UploadCatalogue'))
	
	//Publish new item
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/Checkbox'))
	t(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/ItemPrice'), ItemPrice)
	//UOM
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/UOMFind'))
	selectDropdownByIndex(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/UOMDropdown'),'2')
	t(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeInput'), UOMName)
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/UNSPSCCodeSearch'))
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/FirstCodeResult'))
	c(findTestObject('Object Repository/CreateCatalogue/CreateUNSPSCCode/SelectButton'))
	
	//Image
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/ImageUpload'))
	//BasicSpec
	t(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/BasicSpecification'), BasicSpecification)
	// Use uploadFile to directly send the file path
	WebUI.uploadFile(
		findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/ChooseImage'),
		'C:\\KatalonDummy\\dummy.png')
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/CloseImageandSpec'))
	//Calendar
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/CatalogueStartDate'))
	pickDate("2026-06-30")
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/CatalogueEndDate'))
	pickDate("2026-07-14")
	
	//Publish
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/SubmitCatalogueButton'))
	
	//DeclarationCheckBox
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/DeclarationCheckBox'))
	c(findTestObject('Object Repository/CreateCatalogue/CreateNewCatalogueItemPage/DeclarationYes'))