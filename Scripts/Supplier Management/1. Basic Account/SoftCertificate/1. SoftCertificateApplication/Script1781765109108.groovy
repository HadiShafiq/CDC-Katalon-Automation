...
//Soft Cert Application
	c(findTestObject('Object Repository/Home Page/SupplierPage/SoftCertApplication'))
	
//Application menu
	c(findTestObject('Object Repository/SoftCertification/ApplicationProceed'))
	
//Appointed Supplier Admin
	//Upload documents
	//Mykad
	c(findByXPath("(//a[contains(@onclick,'uploadDialog.show()')])[1]"))
	waitBlockUI(5)
	WebUI.uploadFile(findTestObject('Object Repository/SoftCertification/ChooseFile'),'C:\\KatalonDummy\\dummy.png')
	c(findTestObject('Object Repository/SoftCertification/UploadFile'))
	//Cert of Incorporation
	c(findByXPath("(//a[contains(@onclick,'uploadDialog.show()')])[2]"))
	waitBlockUI(5)
	WebUI.uploadFile(findTestObject('Object Repository/SoftCertification/ChooseFile'),'C:\\KatalonDummy\\dummy.png')
	c(findTestObject('Object Repository/SoftCertification/UploadFile'))
	//Official Application Letter
	c(findByXPath("(//a[contains(@onclick,'uploadDialog.show()')])[3]"))
	waitBlockUI(5)
	WebUI.uploadFile(findTestObject('Object Repository/SoftCertification/ChooseFile'),'C:\\KatalonDummy\\dummy.png')
	c(findTestObject('Object Repository/SoftCertification/UploadFile'))
	
	//Request Softcert Button
	c(findTestObject('Object Repository/SoftCertification/RequestSoftcert'))
	//Submit button
	c(findTestObject('Object Repository/SoftCertification/SubmitSoftSertApp'))
	
	//Declaration
	c(findTestObject('Object Repository/SoftCertification/DeclarationCheckbox'))
	c(findTestObject('Object Repository/SoftCertification/DeclarationYes'))
