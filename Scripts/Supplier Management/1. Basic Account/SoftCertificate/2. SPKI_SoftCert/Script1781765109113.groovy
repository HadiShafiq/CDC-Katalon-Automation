 ...
 * ========================= */
WebUI.navigateToUrl('https://digitalid.msctrustgate.com/v2/pilot/ePRA')
WebUI.maximizeWindow()
waitBlockUI(20)

//Sign In
t(findTestObject('Object Repository/SPKI_Portal/Username_Input'),SPKIUsername)
t(findTestObject('Object Repository/SPKI_Portal/Password_Input'),SPKIPassword)
//button
c(findTestObject('Object Repository/SPKI_Portal/SignIn'))

//Search filter
t(findTestObject('Object Repository/SPKI_Portal/UserIDSearch'),UserID)
c(findTestObject('Object Repository/SPKI_Portal/UserIDSearch_Button'))
//Select
c(findTestObject('Object Repository/SPKI_Portal/Select'))

//Certificate Request Page
c(findTestObject('Object Repository/SPKI_Portal/Approve'))
