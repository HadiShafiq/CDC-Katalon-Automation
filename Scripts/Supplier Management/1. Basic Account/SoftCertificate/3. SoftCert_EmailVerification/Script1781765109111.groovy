...
//Sila klik pada pautan di bawah untuk menetapkan PIN dan Soalan Keselamatan.
c(findTestObject('Object Repository/SPKI_Portal/EnrolmentLink'))
...
//Challenge Response
	...
	//1
	selectDropdownByIndex(findTestObject('Object Repository/EmailVerification/Digital_ID/ChallengeResponse1'),'1')
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/Answer1'),Answer1)
	
	//2
	selectDropdownByIndex(findTestObject('Object Repository/EmailVerification/Digital_ID/ChallengeResponse2'),'2')
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/Answer2'),Answer2)
	
	//3
	selectDropdownByIndex(findTestObject('Object Repository/EmailVerification/Digital_ID/ChallengeResponse3'),'3')
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/Answer3'),Answer3)
	
	//4
	selectDropdownByIndex(findTestObject('Object Repository/EmailVerification/Digital_ID/ChallengeResponse4'),'4')
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/Answer4'),Answer4)
		
	//5
	selectDropdownByIndex(findTestObject('Object Repository/EmailVerification/Digital_ID/ChallengeResponse5'),'5')
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/Answer5'),Answer5)
	
	//PIN
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/PinInput'),PIN)
	t(findTestObject('Object Repository/EmailVerification/Digital_ID/PinInputConfirm'),PIN)
	
	//Submit
	c(findTestObject('Object Repository/EmailVerification/Digital_ID/PinSubmit'))