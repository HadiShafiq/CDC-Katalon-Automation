...
//Click MOF Account radio button
...
//Potential SSM thingy (need recheck)
//MOF Supplier type		
selectDropdownByIndex(findTestObject('Object Repository/SupplierRegistration/AccInfoPage/AccInfo/MOF_SupplierType'),MOFSupplierType)
//Business type
